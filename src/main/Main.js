    ...
    return (
        <main>
            <section className="feature__parent">
                ...
                <Features src={financial} alt="passions" caption="Gain financial freedom" leftalign={true}
                ...
                <Features src={work} alt="passions" caption=" Work from anywhere" leftalign={true}
